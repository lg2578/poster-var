...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=14, patch_size=14, in_c=147, num_classes=7,
        ...
        # self.se_block2 = SE_block2(input_dim=embed_dim)
        ...
        self.head_vae=VaeClassifier(in_features=embed_dim,out_features=self.num_classes)
        # self.head_cosine=ArcMarginProduct(in_features=256,out_features=self.num_classes)
        # self.se_block3=ChannelGate(gate_channels=embed_dim)
    ...
    def forward(self, x):
        ...
        if self.vae:
            ...
            x1 = self.head(x)
        # x1=x1[0]# x1=out,mu,logvar
        # x1=self.head_cosine(x1)
